...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Instagram Feed - Using Embed */}
      <section className="py-12 md:py-16 border-t border-black/5 bg-gradient-to-b from-white to-gray-50/30">
        <div className="px-6 max-w-5xl mx-auto">
          ...
          <div className="flex justify-center">
            <iframe 
              src="https://www.instagram.com/bohemiaromanroad/embed"
              className="border-0 rounded-xl overflow-hidden"
              style={{ width: '100%', maxWidth: '500px', height: '580px' }}
              scrolling="no"
        ...
        <div className="px-6 py-16 md:py-20">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-4 gap-12 mb-16">
              ...
              <div className="md:col-span-2">
                ...
                >
                  ...
                  Follow us @bohemiaromanroad
                </a>
              </div>

              {/* Quick Links */}
              <div>
                <h5 className="text-xs uppercase tracking-[0.2em] text-white/40 mb-4">Explore</h5>
              ...
              {/* Contact */}
              <div>
                <h5 className="text-xs uppercase tracking-[0.2em] text-white/40 mb-4">Contact</h5>
                <ul className="space-y-3 text-sm text-white/70">
                  <li>Roman Road</li>
                  <li>Bow, London</li>
                  <li className="pt-2">
                    <a href="mailto:hello@bohemia.co.uk" className="hover:text-white transition">
                      hello@bohemia.co.uk
                    </a>
                  </li>
                </ul>
            ...
            <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <p className="text-xs text-white/40">
                Curated treasures on Roman Road
              </p>
            </div>
          </div>
        </div>
