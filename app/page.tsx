...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Our Story - Moved between products and Instagram */}
        ...
        <div className="relative h-[50vh] min-h-[400px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="max-w-2xl mx-auto px-6 text-center text-white">
              <p className="text-xs uppercase tracking-[0.4em] text-white/60 mb-4">Our Story</p>
              <h3 
              ...
              <p className="text-white/80 leading-relaxed text-sm max-w-lg mx-auto">
      ...
      <section className="py-16 md:py-20 border-t border-black/5 bg-gradient-to-b from-white to-gray-50/30">
        ...
        <div className="max-w-3xl mx-auto px-6">
          <iframe 
            src="https://www.instagram.com/bohemiaromanroad/embed/?hl=en"
            className="border-0 rounded-xl overflow-hidden w-full"
            style={{ height: '650px' }}
            scrolling="no"
            frameBorder="0"
          />
      ...
      <footer className="bg-black text-white">
        <div className="px-8 py-24 md:py-32">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-16 md:gap-12 mb-24 md:mb-28">
              {/* About */}
              <div className="text-center md:text-left">
                <h5 className="text-[10px] uppercase tracking-[0.25em] text-white/40 mb-6">About</h5>
              ...
              <div className="text-center">
                <h5 className="text-[10px] uppercase tracking-[0.25em] text-white/40 mb-6">Explore</h5>
                <ul className="space-y-4 text-sm">
                  <li><a href="#collection" className="text-white/60 hover:text-white transition">Collection</a></li>
                  <li><a href="#story" className="text-white/60 hover:text-white transition">Our Story</a></li>
                  <li><button onClick={() => setShowSellModal(true)} className="text-white/60 hover:text-white transition">Sell Your Item</button></li>
                </ul>
              </div>

              {/* Contact */}
              <div className="text-center md:text-right">
                <h5 className="text-[10px] uppercase tracking-[0.25em] text-white/40 mb-6">Visit</h5>
