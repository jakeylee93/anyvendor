      ...
      <div className={`slide-snap ${activeSlide === 0 ? "active" : ""}`}>
        <div className="slide-page title-slide">
          <div className="title-logos-bg">
            {[
              { src: '/logos/openai.svg', x: 6, y: 10, size: 46, delay: 0 },
              { src: '/logos/anthropic.svg', x: 80, y: 6, size: 44, delay: 1.5 },
              { src: '/logos/gemini.svg', x: 16, y: 75, size: 42, delay: 0.8 },
              { src: '/logos/chatgpt.svg', x: 88, y: 70, size: 44, delay: 2.1 },
              { src: '/logos/discord.svg', x: 3, y: 44, size: 38, delay: 3.2 },
              { src: '/logos/telegram.svg', x: 90, y: 36, size: 40, delay: 1.2 },
              { src: '/logos/whatsapp.svg', x: 72, y: 84, size: 40, delay: 2.8 },
              { src: '/logos/gmail.svg', x: 22, y: 90, size: 36, delay: 0.4 },
              { src: '/logos/meta.svg', x: 64, y: 12, size: 42, delay: 3.8 },
              { src: '/logos/supabase.svg', x: 36, y: 4, size: 40, delay: 2.4 },
              { src: '/logos/brave.svg', x: 92, y: 52, size: 36, delay: 1.8 },
              { src: '/logos/gcal.svg', x: 50, y: 88, size: 34, delay: 3.5 },
              { src: '/logos/perplexity.svg', x: 12, y: 26, size: 36, delay: 0.6 },
              { src: '/logos/mistral.svg', x: 44, y: 70, size: 38, delay: 2.6 },
              { src: '/logos/openclaw.svg', x: 48, y: 8, size: 40, delay: 4.1 },
              { src: '/logos/github.svg', x: 78, y: 48, size: 38, delay: 0.3 },
              { src: '/logos/stripe.svg', x: 28, y: 58, size: 42, delay: 1.9 },
              { src: '/logos/slack.svg', x: 58, y: 80, size: 36, delay: 3.0 },
              { src: '/logos/python.svg', x: 8, y: 60, size: 36, delay: 4.4 },
              { src: '/logos/elevenlabs.svg', x: 68, y: 28, size: 34, delay: 2.2 },
            ].map((logo, i) => (
              <img
                key={i}
                src={logo.src}
