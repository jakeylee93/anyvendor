    ...
    <>
      ...
      <section className="bg-[#1a1a2e] py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <AnimatedIcon animation="fade-up" delay={200}>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12">
          {[
            ...
            <div key={item.step}>
              <AnimatedIcon animation={item.anim} delay={idx * 200}>
              ...
              <AnimatedIcon animation="fade-up" delay={idx * 200 + 100}>
              ...
              <AnimatedIcon animation="fade-up" delay={idx * 200 + 200}>
      ...
      <section className="bg-white py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <AnimatedIcon animation="slide-right">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { icon: Search, title: "Smart Search", desc: "Find suppliers by category, location, price range, and event type.", anim: "scale-bounce" as const },
              { icon: Star, title: "Genuine Reviews", desc: "Read real reviews from people who've actually booked these vendors.", anim: "rotate-in" as const },
              { icon: Heart, title: "Save Favourites", desc: "Create an account and save vendors you love to compare later.", anim: "scale-bounce" as const },
              { icon: Shield, title: "Verified Vendors", desc: "Premium vendors are verified — you know you're dealing with professionals.", anim: "rotate-in" as const },
              { icon: Zap, title: "Zero Fees", desc: "No booking fees, no commission. What you see is what you pay.", anim: "scale-bounce" as const },
              { icon: Users, title: "Plan My Event", desc: "Tell us what you need and we'll match you with the right suppliers.", anim: "rotate-in" as const },
            ].map((item, idx) => (
              <AnimatedIcon key={item.title} animation={item.anim} delay={idx * 100}>
                <div className="bg-[#faf8f5] rounded-2xl p-5 border border-gray-100 h-full">
                  <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center mb-3 shadow-sm">
                    <item.icon size={18} className="text-[#e2b33e]" />
                  </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {/* Free */}
          <AnimatedIcon animation="fade-up" delay={0}>
            <div className="bg-white rounded-2xl border border-gray-200 p-6 h-full">
              ...
              <ul className="mt-6 space-y-3">
                {["Basic profile page", "Listed in directory & search", "1 cover photo", "Business description", "Category listing", "Email contact button"].map((f) => (
              ...
              <div className="mt-6 pt-4 border-t border-gray-100">
                ...
                <ul className="space-y-2">
                  {["Premium badge", "Photo gallery", "Phone & website visible", "Priority in search", "Analytics dashboard", "No competitor ads on profile"].map((f) => (
                    <li key={f} className="flex items-center gap-2 text-gray-400 text-xs line-through">{f}</li>
                  ))}
                </ul>
              </div>

              <Link href="/list-your-business" className="mt-6 w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold text-sm py-3 rounded-full transition-colors block text-center">
                Get Started Free
              </Link>
            </div>
          </AnimatedIcon>
          ...
          {/* Premium */}
          <AnimatedIcon animation="fade-up" delay={200}>
            <div className="bg-[#1a1a2e] rounded-2xl border-2 border-[#e2b33e] p-6 relative h-full">
              ...
              <Link href="/list-your-business" className="mt-6 w-full bg-[#e2b33e] hover:bg-[#f0c75e] text-[#1a1a2e] font-bold text-sm py-3 rounded-full transition-colors block text-center">
      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              { icon: Shield, title: "Trusted Suppliers", desc: "Premium vendors are verified. We check they're legitimate, insured, and ready to deliver.", anim: "rotate-in" as const },
              { icon: Zap, title: "Zero Commission", desc: "We never take a cut of your bookings. What the vendor quotes is what you pay. Simple.", anim: "scale-bounce" as const },
              { icon: Globe, title: "UK-Wide Coverage", desc: "From London to Edinburgh, Essex to Cornwall. Find suppliers wherever your event is.", anim: "rotate-in" as const },
            ].map((item, idx) => (
              <AnimatedIcon key={item.title} animation={item.anim} delay={idx * 150}>
                <div>
