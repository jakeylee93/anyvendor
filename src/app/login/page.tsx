    ...
    <>
      ...
      <div className="max-w-md mx-auto px-4 py-16">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-2">Sign in to your AnyVendor account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-500 text-xs">
              ...
              <Link href="/signup" className="text-[#e2b33e] font-semibold hover:underline">Sign up</Link>
            </p>
            <p className="text-gray-400 text-xs mt-2">
              Are you a vendor?{" "}
              <Link href="/list-your-business" className="text-[#e2b33e] font-semibold hover:underline">List your business</Link>
            </p>
          </div>
        </div>
      </div>
